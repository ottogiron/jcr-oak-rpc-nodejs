...
API.TPropertyState = module.exports.TPropertyState = function(args) {
  this.count = null;
  this.name = null;
  this.size = null;
  this.isArray = null;
...
API.TPropertyState.prototype = {};
API.TPropertyState.prototype.read = function(input) {
...
API.TPropertyState.prototype.write = function(output) {
...
API.TTree = module.exports.TTree = function(args) {
  this.path = null;
  this.root = null;
  this.exists = null;
  this.name = null;
...
API.TTree.prototype = {};
API.TTree.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
API.TTree.prototype.write = function(output) {
