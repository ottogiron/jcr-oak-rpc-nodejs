...
API.TTreeService_addChild_args.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.STRING) {
        this.primaryType = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
...
API.TTreeService_addChild_args.prototype.write = function(output) {
  ...
  if (this.primaryType !== null && this.primaryType !== undefined) {
    output.writeFieldBegin('primaryType', Thrift.Type.STRING, 2);
    output.writeString(this.primaryType);
    output.writeFieldEnd();
  }
  if (this.tree !== null && this.tree !== undefined) {
    output.writeFieldBegin('tree', Thrift.Type.STRUCT, 3);
...
API.TTreeServiceClient.prototype.addChild = function(name, primaryType, tree, callback) {
  ...
  if (callback === undefined) {
    ...
    this.send_addChild(name, primaryType, tree);
...
API.TTreeServiceProcessor.prototype.process_addChild = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.addChild.length === 3) {
    Q.fcall(this._handler.addChild, args.name, args.primaryType, args.tree)
    ...
    this._handler.addChild(args.name, args.primaryType, args.tree,  function (err, result) {
