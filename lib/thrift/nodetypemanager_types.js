...
NodeType.TValue = module.exports.TValue = function(args) {
...
NodeType.TValue.prototype = {};
NodeType.TValue.prototype.read = function(input) {
...
NodeType.TValue.prototype.write = function(output) {
  output.writeStructBegin('TValue');
...
NodeType.TPropertyDefinition = module.exports.TPropertyDefinition = function(args) {
  ...
  if (args) {
    ...
    if (args.isAutocreated !== undefined) {
      this.isAutocreated = args.isAutocreated;
    }
    if (args.isMandatory !== undefined) {
...
NodeType.TPropertyDefinition.prototype = {};
NodeType.TPropertyDefinition.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      ...
      case 7:
      if (ftype == Thrift.Type.BOOL) {
        this.isAutocreated = input.readBool();
      } else {
        input.skip(ftype);
      }
      break;
      case 8:
      if (ftype == Thrift.Type.BOOL) {
        this.isMandatory = input.readBool();
      } else {
        input.skip(ftype);
      }
      break;
...
NodeType.TPropertyDefinition.prototype.write = function(output) {
  output.writeStructBegin('TPropertyDefinition');
  ...
  if (this.isAutocreated !== null && this.isAutocreated !== undefined) {
    output.writeFieldBegin('isAutocreated', Thrift.Type.BOOL, 7);
    output.writeBool(this.isAutocreated);
    output.writeFieldEnd();
  }
  if (this.isMandatory !== null && this.isMandatory !== undefined) {
    output.writeFieldBegin('isMandatory', Thrift.Type.BOOL, 8);
    output.writeBool(this.isMandatory);
    output.writeFieldEnd();
  }
  if (this.isProtected !== null && this.isProtected !== undefined) {
    output.writeFieldBegin('isProtected', Thrift.Type.BOOL, 9);
...
NodeType.TNodeDefinition = module.exports.TNodeDefinition = function(args) {
  ...
  if (args) {
    ...
    if (args.declaringNodeType !== undefined) {
      this.declaringNodeType = args.declaringNodeType;
    }
    if (args.name !== undefined) {
      this.name = args.name;
    }
...
NodeType.TNodeDefinition.prototype = {};
NodeType.TNodeDefinition.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      ...
      case 3:
      if (ftype == Thrift.Type.STRING) {
        this.declaringNodeType = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
...
NodeType.TNodeDefinition.prototype.write = function(output) {
  output.writeStructBegin('TNodeDefinition');
  ...
  if (this.declaringNodeType !== null && this.declaringNodeType !== undefined) {
    output.writeFieldBegin('declaringNodeType', Thrift.Type.STRING, 3);
    output.writeString(this.declaringNodeType);
    output.writeFieldEnd();
  }
  if (this.name !== null && this.name !== undefined) {
...
NodeType.TNodeType = module.exports.TNodeType = function(args) {
  this.name = null;
...
NodeType.TNodeType.prototype = {};
NodeType.TNodeType.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem22 = null;
          elem22 = new ttypes.TPropertyDefinition();
          elem22.read(input);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem29 = null;
          elem29 = new ttypes.TNodeDefinition();
          elem29.read(input);
...
NodeType.TNodeType.prototype.write = function(output) {
  output.writeStructBegin('TNodeType');
  if (this.name !== null && this.name !== undefined) {
